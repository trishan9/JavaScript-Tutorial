---
title: Day 19/30 - JavaScript
metaTitle: Day 19/30 Days of JavaScript — Trishan
metaDescription: Day 19 of JavaScript
layout: ../../layouts/CoursesLayout.astro
banner: https://raw.githubusercontent.com/Asabeneh/30-Days-Of-JavaScript/master/images/banners/day_1_19.png
---
...
const countries = ['Nepal', 'Denmark', 'Sweden', 'Norway', 'Iceland']
const languages = ['Nepali', 'Arabic', 'English', 'French', 'Spanish']
...
const names = ['Trishan', 'Abiral', 'Nischay', 'Nishant']
...
🌕 You are tidy. Now, you knew how to write clean code, so anyone who know the English language can understand your code.  You are always progressing and you are a head of 19 steps to your way to greatness.
