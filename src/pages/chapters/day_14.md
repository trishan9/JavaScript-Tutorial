---
title: Day 14/30 - JavaScript
metaTitle: Day 14/30 Days of JavaScript — Trishan
metaDescription: Day 14 of JavaScript
layout: ../../layouts/CoursesLayout.astro
banner: https://raw.githubusercontent.com/Asabeneh/30-Days-Of-JavaScript/master/images/banners/day_1_14.png
---
...
const person1 = new Person('Trishan', 'Wagle')

console.log(person1)
```

```sh
Person {firstName: "Trishan", lastName: "Wagle"}
```
...
const person3 = new Person('Abraham', 'Wagle')
...
Person {firstName: "Abraham", lastName: "Wagle"}
```
...
const person1 = new Person('Trishan', 'Wagle', 250, 'Nepal', 'Kathmandu')

console.log(person1)
```

```sh
Person {firstName: "Trishan", lastName: "Wagle", age: 250, country: "Nepal", city: "Kathmandu"}
```
...
["Planning", "Managing", "Organizing"]
[]
Trishan Wagle is 250. He lives Nepal, Kathmandu. He knows HTML, CSS and JavaScript
...
const s1 = new Student('Trishan', 'Wagle', 'Nepal', 250, 'Kathmandu')
console.log(s1)
...
```sh
Student {firstName: "Trishan", lastName: "Wagle", age: "Nepal", country: 250, city: "Kathmandu", …}
I am a child of the person class
Trishan Wagle
Student {firstName: "Trishan", lastName: "Wagle", age: "Finland", country: 250, city: "Helsinki", …}
Trishan Wagle is Finland. He lives Helsinki, 250.
```
...
```sh
Student {firstName: "Trishan", lastName: "Wagle", age: 250, country: "Nepal", city: "Kathmandu", …}
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Finland", city: "Helsinki", …}
I am a child of the person class
Trishan Wagle
Student {firstName: "Trishan", lastName: "Wagle", age: 250, country: "Nepal", city: "Kathmandu", …}
Trishan Wagle is 250. He lives in Helsinki, Finland. He knows HTML, CSS and JavaScript
I am a child of the person class
Lidiya Tekle
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Finland", city: "Helsinki", …}
...
🌕 You are excelling. Now, you knew class and you have the power to turn everything to an object. You made it to 14 days of greatness.