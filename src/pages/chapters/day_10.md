---
title: Day 10/30 - JavaScript
metaTitle: Day 10/30 Days of JavaScript — Trishan
metaDescription: Day 10 of JavaScript
layout: ../../layouts/CoursesLayout.astro
banner: https://raw.githubusercontent.com/Asabeneh/30-Days-Of-JavaScript/master/images/banners/day_1_10.png
---
...
```js
const countries = [['Nepal', 'Helsinki'], ['Sweden', 'Stockholm'], ['Norway', 'Oslo']]
...
console.log(getPersonInfo(person))
/*
Trishan Wagle lives in Nepal. He is  250 years old. He is an Instructor and Developer. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, Python and D3.js. He speaks Amharic, English and a little bit of Suomi(Finnish)
*/
```
