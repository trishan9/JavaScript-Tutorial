---
title: Day 16/30 - JavaScript
metaTitle: Day 16/30 Days of JavaScript — Trishan
metaDescription: Day 16 of JavaScript
layout: ../../layouts/CoursesLayout.astro
banner: https://raw.githubusercontent.com/Asabeneh/30-Days-Of-JavaScript/master/images/banners/day_1_16.png
---
...
![web_storage](https://raw.githubusercontent.com/Asabeneh/30-Days-Of-JavaScript/master/images/web_storage.png)
...
![local_storage](https://raw.githubusercontent.com/Asabeneh/30-Days-Of-JavaScript/master/images/local_storage.png)
...
```js
localStorage.setItem('firstName', 'Trishan') // since the value is string we do not stringify it
console.log(localStorage)
```

```sh
Storage {firstName: 'Trishan', length: 1}
```
...
```sh
 Storage {age: '200', firstName: 'Trishan', length: 2}
```
...
```sh
Storage {age: '200', firstName: 'Trishan', skills: 'HTML,CSS,JS,React', length: 3}
```
...
🌕 You are determined .Now, you knew a Web Storages and you knew how to store small data on client browsers. You are 16 steps a head to your way to greatness.